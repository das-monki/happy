...
export const zhHans: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny（英语）",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base（英语）",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small（英语）",
  ...
  settingsSTT: {
    title: "语音转文字",
    description: "使用 Whisper 在设备上将语音转录为文字。模型在首次使用时下载。",
    enabled: "设备端转录已启用",
    disabled: "语音转文字已禁用",
    language: "语言",
    languageAuto: "自动检测",
    ...
    modelDownloading: ({ progress }: { progress: number }) => `下载中 ${progress}%`,
    recording: "录音中...",
    transcribing: "转录中...",
    cancel: "取消",
  },
