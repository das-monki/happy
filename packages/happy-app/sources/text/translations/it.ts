...
export const it: TranslationStructure = {
  ...
  tasks: {
    ...
    additionalInstructions: "Istruzioni aggiuntive (facoltativo)",
    ...
    artifacts: "Artefatti",
    addArtifact: "Aggiungi artefatto",
    includeArtifacts: "Includi artefatti",
  },
  ...
  settings: {
    ...
    agents: "Agenti",
    agentsSubtitle: "Gestisci i modelli di agenti",
    profiles: "Profili",
    profilesSubtitle:
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny (inglese)",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base (inglese)",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small (inglese)",
  ...
  settingsSTT: {
    ...
    description: "Trascrivi la voce in testo sul dispositivo usando Whisper. I modelli vengono scaricati al primo utilizzo.",
    enabled: "Trascrizione sul dispositivo attivata",
    disabled: "Riconoscimento vocale disattivato",
    language: "Lingua",
    ...
    modelReady: "Pronto",
    modelNotDownloaded: "Non scaricato",
    modelDownloading: ({ progress }: { progress: number }) => `Scaricamento ${progress}%`,
