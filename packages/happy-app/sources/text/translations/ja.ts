...
export const ja: TranslationStructure = {
  ...
  settings: {
    ...
    agents: "エージェント",
    agentsSubtitle: "エージェントテンプレートを管理",
    profiles: "プロファイル",
  ...
  settingsSTT: {
    title: "音声テキスト変換",
    description: "Whisperを使用してデバイス上で音声をテキストに変換します。モデルは初回使用時にダウンロードされます。",
    enabled: "デバイス上の文字起こしが有効",
    disabled: "音声テキスト変換が無効",
    language: "言語",
    languageAuto: "自動検出",
    languageEn: "英語",
    languageZh: "中国語",
    ...
    modelDownloading: ({ progress }: { progress: number }) => `ダウンロード中 ${progress}%`,
    recording: "録音中...",
    transcribing: "文字起こし中...",
    cancel: "キャンセル",
  },
