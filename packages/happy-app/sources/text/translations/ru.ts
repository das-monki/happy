...
export const ru: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny (английский)",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base (английский)",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small (английский)",
  ...
  settingsSTT: {
    ...
    description: "Транскрибируйте голос в текст на устройстве с помощью Whisper. Модели загружаются при первом использовании.",
    enabled: "Распознавание речи на устройстве включено",
    disabled: "Распознавание речи отключено",
    language: "Язык",
    ...
    modelDownloading: ({ progress }: { progress: number }) => `Загрузка ${progress}%`,
    recording: "Запись...",
