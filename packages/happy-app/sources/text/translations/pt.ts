...
export const pt: TranslationStructure = {
  ...
  tasks: {
    ...
    archivedGroup: "Arquivadas",
    artifacts: "Artefatos",
    addArtifact: "Adicionar artefato",
    includeArtifacts: "Incluir artefatos",
  },
  ...
  common: {
    ...
    noContent: "Nada para visualizar",
  },
  ...
  settings: {
    ...
    server: "Servidor",
    serverSubtitle: "Configuração do servidor personalizado",
  ...
  settingsAppearance: {
    ...
    showArchivedTasks: "Mostrar tarefas arquivadas",
    showArchivedTasksDescription:
      "Exibir tarefas arquivadas na visualização de tarefas",
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny (inglês)",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base (inglês)",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small (inglês)",
    ...
    assistantAutoApprove: "Aprovação automática de permissões",
    assistantAutoApproveDescription:
      "Quando ativado, o assistente pode aprovar ou negar automaticamente solicitações de permissões nas suas sessões. Quando desativado, você deve aprovar as permissões manualmente.",
    assistantAgentPrompt: "AGENTS.md",
    assistantAgentPromptSubtitle: "Instruções do agente e uso de ferramentas",
    assistantSoulPrompt: "SOUL.md",
    assistantSoulPromptSubtitle: "Personalidade e comportamento",
  },
  ...
  settingsSTT: {
    ...
    description: "Transcreva voz para texto no dispositivo usando Whisper. Os modelos são baixados no primeiro uso.",
    enabled: "Transcrição no dispositivo ativada",
    disabled: "Voz para texto desativado",
    language: "Idioma",
    ...
    modelReady: "Pronto",
    modelNotDownloaded: "Não baixado",
    modelDownloading: ({ progress }: { progress: number }) => `Baixando ${progress}%`,
    recording: "Gravando...",
