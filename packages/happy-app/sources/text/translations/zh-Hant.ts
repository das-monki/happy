...
export const zhHant: TranslationStructure = {
  ...
  tasks: {
    ...
    archiveSessionsWarning: ({ count }: { count: number }) =>
      `${count} 個活躍的工作階段將被停止。工作階段歷史記錄將被保留。`,
    deleteWithSessionsWarning: ({
      ...
      `${count} 個活躍的工作階段將被停止，所有工作階段資料將被永久刪除。確定要刪除「${name}」嗎？`,
    completeTitle: "完成任務",
    completeConfirm: "完成",
    failTitle: "標記為失敗",
    failConfirm: "標記失敗",
  ...
  settingsFeatures: {
    ...
    speechToTextDescription:
      "啟用使用 Whisper 的裝置端語音轉文字轉錄。模型在首次使用時下載。",
    speechToTextEnabled: "語音轉文字已啟用",
    speechToTextDisabled: "語音轉文字已停用",
    speechToTextModel: "Whisper 模型",
    speechToTextModelTinyEn: "Tiny（英語）",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base（英語）",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small（英語）",
    speechToTextModelSmallEnSize: "466 MB",
    speechToTextModelReady: "就緒",
    speechToTextModelNotDownloaded: "未下載",
  ...
  settingsSTT: {
    title: "語音轉文字",
    description: "使用 Whisper 在裝置上將語音轉錄為文字。模型在首次使用時下載。",
    enabled: "裝置端轉錄已啟用",
    disabled: "語音轉文字已停用",
    language: "語言",
    languageAuto: "自動偵測",
    ...
    modelDownloading: ({ progress }: { progress: number }) => `下載中 ${progress}%`,
    recording: "錄音中...",
    transcribing: "轉錄中...",
    cancel: "取消",
  },
  ...
  assistant: {
    ...
    placeholder: "詢問你的助理...",
    startAssistant: "啟動助理",
    noMachineOnline: "沒有機器在線",
    clearConversation: "新對話",
    clearConfirmTitle: "新對話",
    clearConfirmMessage: "這將結束目前的對話並開始新的對話。",
    connecting: "啟動中...",
