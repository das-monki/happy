...
export const en: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny (English)",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base (English)",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small (English)",
  ...
  settingsSTT: {
    ...
    description: "Transcribe voice to text on-device using Whisper. Models are downloaded on first use.",
    ...
    modelDownloading: ({ progress }: { progress: number }) => `Downloading ${progress}%`,
    recording: "Recording...",
