...
export const ca: TranslationStructure = {
  ...
  tasks: {
    ...
    additionalInstructions: "Instruccions addicionals (opcional)",
  ...
  settings: {
    ...
    agents: "Agents",
    agentsSubtitle: "Gestiona les plantilles d'agents",
    profiles: "Perfils",
  ...
  settingsFeatures: {
    ...
    speechToTextModelTinyEn: "Tiny (anglès)",
    speechToTextModelTinyEnSize: "75 MB",
    speechToTextModelBaseEn: "Base (anglès)",
    speechToTextModelBaseEnSize: "142 MB",
    speechToTextModelSmallEn: "Small (anglès)",
  ...
  settingsSTT: {
    title: "Veu a text",
    description: "Transcriu la veu a text al dispositiu amb Whisper. Els models es descarreguen al primer ús.",
    enabled: "Transcripció al dispositiu activada",
    disabled: "Veu a text desactivat",
    language: "Idioma",
    languageAuto: "Detecció automàtica",
    languageEn: "Anglès",
    languageZh: "Xinès",
    languageDe: "Alemany",
    languageEs: "Espanyol",
    ...
    modelReady: "Preparat",
    modelNotDownloaded: "No descarregat",
    modelDownloading: ({ progress }: { progress: number }) => `Descarregant ${progress}%`,
